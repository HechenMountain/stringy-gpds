...
def fourier_transform_moment(moment_type, moment_label, n, b_vec, Delta_max = 5,num_points=100, error_type="central"):
    """
...
def plot_fourier_transform_moments(moment_type, moment_label, plot_title,n=1, b_max = 2,Delta_max = 5,num_points=100):
    """
    ...
    fourier_transform_moment_values_flat = Parallel(n_jobs=-1)(delayed(fourier_transform_moment)(moment_type, moment_label,n,b_vec,Delta_max,num_points) for b_vec in b_vecs)
